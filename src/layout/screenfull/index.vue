<template>
  <div @click="click">
    <svg t="1590133227479" class="screenfull-svg" viewBox="0 0 1024 1024" version="1.1" width="20" height="20"
    ...
    <svg t="1590133734869" class="screenfull-svg" viewBox="0 0 1024 1024" version="1.1"
         xmlns="http://www.w3.org/2000/svg" p-id="1862"
         xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" v-else>
      <path d="M928.512 959.744a32 32 0 0 1-32-32v-256a32 32 0 0 1 64 0v256a32 32 0 0 1-32 32z" fill=""
            p-id="1863"></path>
      <path
          ...
          fill="" p-id="1864"></path>
      <path d="M63.744 96.256a32 32 0 0 1 32-32h256a32 32 0 0 1 0 64h-256a32 32 0 0 1-32-32z" fill=""
            p-id="1865"></path>
      <path d="M384.064 671.744a32 32 0 0 1-32 32h-256a32 32 0 0 1 0-64h256a32 32 0 0 1 32 32z" fill=""
            p-id="1866"></path>
      <path d="M352.064 639.744a32 32 0 0 1 32 32v256a32 32 0 0 1-64 0v-256a32 32 0 0 1 32-32z" fill=""
            p-id="1867"></path>
      <path
          ...
          fill=""
          p-id="1868"></path>
      <path d="M639.616 352.512a32 32 0 0 1 32-32h256a32 32 0 0 1 0 64h-256a32 32 0 0 1-32-32z" fill=""
            p-id="1869"></path>
      <path d="M671.616 384.512a32 32 0 0 1-32-32v-256a32 32 0 0 1 64 0v256a32 32 0 0 1-32 32z" fill=""
            p-id="1870"></path>
      <path
